...
public class _GameServantStub extends org.omg.CORBA.portable.ObjectImpl implements GameServant
{
  ...
  public boolean gameCanStart () throws NoPlayersJoinedException, PendingGameException
  {
            ...
            try {
                ...
                if (_id.equals ("IDL:wordy_idl/NoPlayersJoinedException:1.0"))
                    ...
                    throw PendingGameExceptionHelper.read ($in);
                else
  ...
  public void submitWord (int userId, String word) throws InvalidWordException, WordLengthException, WrongLetterException
  {
            ...
            try {
                ...
                if (_id.equals ("IDL:wordy_idl/InvalidWordException:1.0"))
                    ...
                    throw WordLengthExceptionHelper.read ($in);
                else if (_id.equals ("IDL:wordy_idl/WrongLetterException:1.0"))
                    throw WrongLetterExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public char[] getLetters ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                char $result[] = randomLettersHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
