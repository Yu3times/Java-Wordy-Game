...
/**
* wordy_idl/randomLettersHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Wordy.idl
* Wednesday, May 10, 2023 8:44:05 AM SGT
*/

abstract public class randomLettersHelper
{
  private static String  _id = "IDL:wordy_idl/randomLetters:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (wordy_idl.randomLettersHelper.id (), "randomLetters", __typeCode);
    }
    return __typeCode;
  }
