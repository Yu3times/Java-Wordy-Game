 ...
 implements wordy_idl.GameServantOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("gameCanStart", new java.lang.Integer (0));
    _methods.put ("gameIsFinished", new java.lang.Integer (1));
    _methods.put ("submitWord", new java.lang.Integer (2));
    _methods.put ("checkPlayerCount", new java.lang.Integer (3));
    _methods.put ("getRemainingPendingTime", new java.lang.Integer (4));
    _methods.put ("getRemainingReadyTime", new java.lang.Integer (5));
    _methods.put ("getRemainingRoundTime", new java.lang.Integer (6));
    _methods.put ("getRemainingResultsTime", new java.lang.Integer (7));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // wordy_idl/GameServant/gameCanStart
       {
         ...
         } catch (wordy_idl.PendingGameException $ex) {
           out = $rh.createExceptionReply ();
           wordy_idl.PendingGameExceptionHelper.write (out, $ex);
         }
         break;
       }
       ...
       case 8:  // wordy_idl/GameServant/getLetters
       {
         ...
         out = $rh.createReply();
         wordy_idl.randomLettersHelper.write (out, $result);
         break;
       }
